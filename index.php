...
<body>
    ...
    <div id="index">
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img src="img/menu/cafe.jpg" alt="Los Angeles" style="width:100%;">
                </div>

                <div class="item">
                    <img src="img/menu/cruasan.jpg" alt="Chicago" style="width:100%;">
                </div>

                <div class="item">
                    <img src="img/menu/sopa.jpg" alt="New york" style="width:100%;">
                </div>
            </div>
        ...
        <div id="carta">
            <h1 style="margin-bottom: 5%; margin-top: 2%; text-align: center;">Nuestra Carta</h1>
            <div class="d-flex justify-content-around">
                <div class="p-2">
                    <img class="imagenes" src="img/menu/cafe.jpg" alt="Café" width="150px" height="150px">
                    <div id="cafe">Café</div>
                </div>
                <div class="p-2">
                    <img class="imagenes" src="img/menu/sopa.jpg" alt="Sopa" width="150px" height="150px">
                    <div id="sopa">Sopa</div>
                </div>
                <div class="p-2">
                    <img class="imagenes" src="img/menu/cruasan.jpg" alt="Cruasan" width="150px" height="150px">
                    <div id="cruasan">Cruasan</div>
                </div>
            </div>
        </div>
    </div>
